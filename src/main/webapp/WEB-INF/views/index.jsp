			...
			<div class="row g-4 g-lg-5">
				...
				<div class="col-lg-6 position-relative">
					...
					<div class="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
						<img class="icon-lg shadow-lg border border-3 border-white rounded-circle" src="images/category/hotel/4by3/11.jpg" alt="avatar">
						<img class="icon-xl shadow-lg border border-3 border-white rounded-circle" src="images/category/hotel/4by3/12.jpg" alt="avatar">
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5 position-relative">
				...
				<div class="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
					<div class="bg-body d-flex d-inline-block rounded-3 position-relative p-3">	
						...
						<!-- Element -->
						<img src="images/element/01.svg" class="position-absolute top-0 start-0 translate-middle w-40px" alt="">
							...
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-5 position-relative">
									...
									<div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
										<img src="images/element/02.svg" class="h-60px bg-orange rounded p-2" alt="">
									</div>
									...
									<!-- Image -->
									<img src="images/team/01.jpg" class="rounded-3 position-relative" alt="">
								</div>
							...
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-5 position-relative">
									...
									<div class="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
										<img src="images/element/03.svg" class="h-60px bg-orange p-2 rounded" alt="">
									</div>
									...
									<!-- Image -->
									<img src="images/team/02.jpg" class="rounded-3 position-relative" alt="">
								</div>
		...
		<div class="row g-4 justify-content-between mt-0 mt-md-2">
			...
			<div class="col-sm-7 col-md-6 col-lg-4">
				...
				<ul class="list-inline mb-0 mt-3">
					<li class="list-inline-item"> <a href="#"><img src="images/element/paypal.svg" class="h-30px" alt=""></a></li>
